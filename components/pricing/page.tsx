...
export default function page() {
  return (
    ...
    >
      ...
      <h2
        className="scroll-m-20 font-caption text-3xl font-semibold tracking-tight 
      ...
      >
        ...
        <b className="relative inline-block">
          ...
          <span className="relative z-10 ">idée</span>{" "}
        </b>{" "}
        en application de{" "}
        <b className="relative inline-block">
          <svg
      ...
      <div className="flex flex-col items-center justify-center lg:flex-row">
        <div className="overflow-hidden shadow w-full max-w-[480px] rounded-lg border border-home_secondary bg-card/20 py-10">
          <div className="relative flex flex-col pt-4 md:pt-6 lg:pt-8">
            ...
            <div className="px-6 mt-10 last-of-type:pt-0 md:px-8 lg:px-10 mt-0 flex flex-col gap-4  py-4 pb-6">
              ...
              text-primary-foreground hover:bg-primary/90 h-11 rounded-md px-8 font-bold"
              >
                Deviens un Pro
              </button>
            </div>
        ...
        >
          {/** */}
          <div className="overflow-hidden shadow w-full max-w-[480px] rounded-lg border border-home_secondary bg-card/20">
            <div className="relative flex flex-col pt-4 md:pt-6 lg:pt-8">
              <div className="mt-6 px-6 last-of-type:pt-0 md:px-8 lg:px-10 flex flex-col gap-2">
                <div className="flex gap-4">
                  <span className="relative flex shrink-0 overflow-hidden size-16 rounded-none shadow shadow-white/10">
